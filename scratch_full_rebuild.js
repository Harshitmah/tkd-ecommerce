              ...
              {selectedNode.type === "condition" && (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      value={selectedNode.config.conditionOperator}
...
const fsPath = 'C:/Antigravity Project/tkd-ecommerce/app/(admin)/admin/workflows/create/page.tsx';
fs.writeFileSync(fsPath, part1 + part2, 'utf8');
